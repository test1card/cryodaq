...
**Активная campaign-ветка:** `feat/montana-phase-a` (последний recorded exact-SHA checkpoint `9c079b3`)
...
**CI recorded checkpoint:** PASS — sharded exact-SHA run `29327748049` для `9c079b3` завершён зелёным: agents/core/GUI/remaining PASS на Windows и Ubuntu. Safe SQLite verification прошла во всех jobs; lint и requirements-lock drift checks прошли в обоих remaining jobs. Каждый более новый candidate требует свой exact-SHA eight-job PASS. Это не закрывает frozen-build, soak-duration, physical-hardware, F35 frozen-packaging или F36 production-activation gates.
...
5. Recorded exact-SHA CI checkpoint `29327748049` для `9c079b3`: все восемь
