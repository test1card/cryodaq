...
| Метрика | Значение |
|---|---|
| Python файлы (`src/cryodaq/`) | **186** |
| Строки кода (`src/cryodaq/`) | **~57 800** |
| Тестовые файлы (`tests/`) | **223** |
| Строки тестов (`tests/`) | **~39 500** |
| Тесты | **~2 457 collected** (2026-05-06 baseline; 1 deselected: @ollama marker) |
| Coverage (full suite) | stale — re-run pending |
| Design System | **v1.0.1**, 67 canonical .md файлов, 139 токенов |
| Версия пакета | **0.52.9** |
