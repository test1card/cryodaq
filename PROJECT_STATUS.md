...
12. **Design system v4.0.3 canonical** — `docs/design-system/**` — единственный источник правды по UI в текущей ветке. Релизный снимок v0.64.1 в таблице выше исторически фиксирует v1.0.1. Значения токенов берутся ТОЛЬКО из `theme.py`.
