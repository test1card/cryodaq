...
class KnowledgeBasePanel(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        # --- Top toolbar: explicit offline-index maintenance notice ---
        toolbar = QFrame()
        ...
        self._rebuild_status_label = QLabel("Индекс: обслуживание офлайн")
        ...
        self._rebuild_button = QPushButton("Индексация офлайн")
        self._rebuild_button.setToolTip("Индексация выполняется вне операторского интерфейса: cryodaq-rag-index.")
        self._rebuild_button.setEnabled(False)
        self._rebuild_button.setAccessibleDescription(
            "Индексация — офлайн-обслуживание. Запустите cryodaq-rag-index вне операторского интерфейса."
        )
