...
class ZmqBridge:
    ...
    def start(self) -> None:
        ...
        # Rotate the snapshot queue before attempting any other cleanup.  If
        # a retained reply owner refuses to settle, the old producer's queue
        # is already detached and cannot be resurrected by a later retry.
