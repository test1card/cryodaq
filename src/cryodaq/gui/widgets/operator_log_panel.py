"""Legacy operator log panel (v1).

DEPRECATED (Phase II.3): Replaced by
``src/cryodaq/gui/shell/overlays/operator_log_panel.py``. This module
is kept alive for the transitional ``main_window.py`` path only and is
