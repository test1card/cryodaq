...
Давления пиши ТОЛЬКО в научной нотации, ровно как они даны выше:
1.65e-06 мбар, 2.9e-01 мбар. Не переводи в десятичную запись и не
используй запись со степенью через «·10⁻⁶».

Хороший пример: "У нас идёт «эксперимент-001» в фазе захолаживания.
Температуры: Т7 Детектор 3.9 K, Т1 Криостат верх 78.2 K.
Давление 1.65e-06 мбар. Тревог нет."
