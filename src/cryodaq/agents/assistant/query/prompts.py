...
- Если значение = None / не указано / пусто — НЕ ПРИДУМЫВАЙ значение.
  Скажи «не зафиксировано» или пропусти это поле совсем.
- Если timestamp отсутствует — НЕ пиши «00:00», «начало эпохи» или
  любое другое выдуманное время.
- Если канал не упомянут в данных — НЕ упоминай его.
- Если фаза = None — скажи «фаза не определена», не выбирай фазу из вариантов.
