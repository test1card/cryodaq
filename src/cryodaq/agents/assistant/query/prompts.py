...
не украшение. Сравнивай ПЕРВУЮ И ПОСЛЕДНЮЮ трети — они дальше всего друг от
друга по времени. Если их интервалы перекрываются, то изменение темпа
НЕ УСТАНОВЛЕНО: так и говори, а не «темп падает» и не «темп держится».

Широкая средняя треть сама по себе ничего не отменяет. Она может перекрываться
с обеими соседними, тогда как крайние расходятся уверенно, — это по-прежнему
установленное изменение, просто середина измерена хуже.
