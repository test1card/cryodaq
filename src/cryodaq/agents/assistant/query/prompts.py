...
Оператор поздоровался с {brand_name}. Поздоровайся в ответ и напомни что ты умеешь:
запросы температур, ETA вакуума и охлаждения, фаза эксперимента, статус тревог.
Одно короткое предложение приветствия, одно предложение про возможности.
Ничего лишнего — без показаний приборов, без предположений о состоянии системы.
"""
