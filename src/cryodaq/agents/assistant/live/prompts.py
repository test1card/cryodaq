...
Форма:
- Только на русском.
- КОРОТКО: до 400 символов, это примерно 50 слов. Сводка едет в подписи к графику,
  а подпись у Telegram ограничена — что не влезет, оператор не увидит. Пиши так, чтобы
  влезало целиком: одна-две мысли, самое важное первым.
