...
class CalibrationSessionStore:
    ...
    def get_session_artifacts(self, session_id: str) -> dict[str, str]:
        return {
            "session_path": str(self._session_metadata_path(session_id)),
            "samples_csv_path": str(self._session_dir(session_id) / "samples.csv"),
        }
