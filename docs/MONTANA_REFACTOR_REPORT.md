...
| Candidate source-inventory text | 424,404 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 424,488 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
| Baseline test Python | 80,529 lines | Python under `tests`. |
| Candidate production Python | 150,066 lines | Candidate `src/cryodaq` inventory, not 134,090. |
| Candidate test Python | 201,318 lines | Candidate `tests` inventory. |
