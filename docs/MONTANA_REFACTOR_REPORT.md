...
| Candidate source-inventory text | 439,397 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 439,481 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 210,543 lines | Candidate `tests` inventory. |
...
| Architecture source manifest | 1,170 | Every intended source file except the self-referential generated `docs/refactor/architecture-*.svg` and `docs/architecture-montana-important.svg` outputs. |
| Delivered-tree files | 1,171 | Source manifest plus the one surviving regenerated architecture SVG. |
