...
| Candidate source-inventory text | 420,666 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 420,750 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 199,161 lines | Candidate `tests` inventory. |
