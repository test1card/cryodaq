...
| Candidate source-inventory text | 414,202 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 414,286 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 194,821 lines | Candidate `tests` inventory. |
