...
| Candidate source-inventory text | 414,102 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 414,186 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 194,754 lines | Candidate `tests` inventory. |
