...
| Candidate source-inventory text | 413,827 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 413,911 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
