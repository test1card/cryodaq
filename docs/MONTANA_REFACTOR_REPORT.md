...
| Candidate source-inventory text | 444,616 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 444,700 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
| Baseline test Python | 80,529 lines | Python under `tests`. |
| Candidate production Python | 152,143 lines | Candidate `src/cryodaq` inventory, not 134,090. |
| Candidate test Python | 212,625 lines | Candidate `tests` inventory. |
