...
| Candidate source-inventory text | 430,007 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 430,091 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 204,512 lines | Candidate `tests` inventory. |
