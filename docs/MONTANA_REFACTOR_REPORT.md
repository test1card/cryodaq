...
| Candidate source-inventory text | 440,623 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 440,707 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Architecture source manifest | 1,171 | Every intended source file except the self-referential generated `docs/refactor/architecture-*.svg` and `docs/architecture-montana-important.svg` outputs. |
| Delivered-tree files | 1,172 | Source manifest plus the one surviving regenerated architecture SVG. |
