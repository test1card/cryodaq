...
| Candidate source-inventory text | 422,617 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 422,701 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
