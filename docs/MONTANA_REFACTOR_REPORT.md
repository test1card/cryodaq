...
| Candidate source-inventory text | 448,124 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 448,208 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 214,523 lines | Candidate `tests` inventory. |
...
| Architecture source manifest | 1,185 | Every intended source file except the self-referential generated `docs/refactor/architecture-*.svg` and `docs/architecture-montana-important.svg` outputs. |
| Delivered-tree files | 1,186 | Source manifest plus the one surviving regenerated architecture SVG. |
