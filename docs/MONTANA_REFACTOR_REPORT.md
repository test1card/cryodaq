...
| Candidate source-inventory text | 460,092 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 460,176 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 221,752 lines | Candidate `tests` inventory. |
