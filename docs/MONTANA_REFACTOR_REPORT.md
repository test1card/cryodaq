...
| Candidate source-inventory text | 418,893 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 418,977 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 198,096 lines | Candidate `tests` inventory. |
