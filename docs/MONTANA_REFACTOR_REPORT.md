...
| Candidate source-inventory text | 446,045 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 446,129 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
