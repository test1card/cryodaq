...
| Candidate source-inventory text | 422,774 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 422,858 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 199,973 lines | Candidate `tests` inventory. |
...
| Architecture source manifest | 1,137 | Every intended source file except the self-referential generated `docs/refactor/architecture-*.svg` and `docs/architecture-montana-important.svg` outputs. |
| Delivered-tree files | 1,138 | Source manifest plus the one surviving regenerated architecture SVG. |
