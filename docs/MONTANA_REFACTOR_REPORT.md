...
| Candidate source-inventory text | 456,604 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 456,688 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 219,888 lines | Candidate `tests` inventory. |
