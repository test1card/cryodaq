...
| Candidate source-inventory text | 438,457 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 438,541 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
