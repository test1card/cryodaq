...
| Candidate source-inventory text | 442,586 lines | Strict UTF-8/no-NUL text in the intended candidate inventory, excluding the one generated architecture SVG. |
| Delivered-tree text | 442,670 lines | Final source inventory plus the one surviving regenerated architecture SVG. |
...
| Candidate test Python | 211,574 lines | Candidate `tests` inventory. |
...
| Architecture source manifest | 1,179 | Every intended source file except the self-referential generated `docs/refactor/architecture-*.svg` and `docs/architecture-montana-important.svg` outputs. |
| Delivered-tree files | 1,180 | Source manifest plus the one surviving regenerated architecture SVG. |
