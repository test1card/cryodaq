...
В верхней части дашборда находится phase widget. Его содержимое меняется
в зависимости от текущей фазы эксперимента:
- Подготовка: проверка что все датчики дают показания
- Захолаживание: прогноз времени до 4К + текущее тепловое сопротивление
- Измерение: текущее тепловое сопротивление
- Разборка: список завершённых фаз
