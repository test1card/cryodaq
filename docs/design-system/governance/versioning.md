...
**Current version:** `4.1.1` — Keithley per-channel badges report physical
source evidence independently from the persistent manager fault latch and its
normal-control gate (see `CHANGELOG.md`).
