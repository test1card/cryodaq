...
**Current version:** `4.1.1` — Keithley retained source-state presentation is
bound to one uninterrupted measurement-flow epoch and requires fresh evidence
after a gap (see `CHANGELOG.md`).
