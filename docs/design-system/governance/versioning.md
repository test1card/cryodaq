...
**Current version:** `4.1.1` — Keithley warning-bearing source starts retain a
standing caution while the source remains active; ordinary result banners stay
transient (see `CHANGELOG.md`).
