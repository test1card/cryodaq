...
**Current version:** v5.0.0 (measured focus and secondary-body contrast
correction; Warm Stone MUTED_FOREGROUND changed to #a59d94 and ToolRail
keyboard focus is bound to its measured ACCENT/SURFACE_PANEL pair).
