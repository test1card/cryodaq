...
**Current version:** v4.2.0 (cooldown history distinguishes unreadable baseline
and partial-history states; operator-state semantic correction: safety green is
