...
18. **No sound ownership.** TopWatchBar never polls `recent_alarms` or derives
    a sound from rows/counts. `AnnunciationController` is the sole shell sound
    owner and consumes the engine's exact activation projection.
