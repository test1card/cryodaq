...
**Session:** v4.1.1 Keithley state-authority correction
...
62. **Design system remains flat-token in the current v4.1.1 line** — the v2.0.0
...
63. **STONE_* remains deprecated/read-only in the current v4.1.1 line** — neither
