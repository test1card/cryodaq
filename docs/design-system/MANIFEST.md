...
**Session:** v4.1.1 Keithley source-state freshness correction
**Scope:** Design system v4.4.0 — foundation tokens + 79 widget rules + 4 governance rules + generic components + CryoDAQ domain primitives + cross-surface patterns + accessibility commitments + governance policies.
