...
Attempt 1 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Tue, 28 Apr 2026 19:01:40 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=5994',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'ac6945a5efcc1546',
...
Attempt 2 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:01:53 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=5788',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '298aa6d8ffe2419',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 3 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:02:07 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=6104',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'acd03d89d61fe4db',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 4 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:02:29 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=5902',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'f8c957dca46f914b',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 5 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:03:06 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=5265',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'c09f8cef73b91124',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 6 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:03:39 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=6492',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'c1a410f18eeecdaa',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 7 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:04:16 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=6845',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '89fb0ec0e753f433',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 8 failed with status 429. Retrying with backoff... _GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Tue, 28 Apr 2026 19:04:50 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=7300',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '10b1489ac6ff4c71',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
- **CRITICAL**: Test functions (`test_slow_commands_covers_safety_critical_hardware_ops` and `test_update_target_updates_runtime_p_target_immediately`) are being added directly into the production source file `src/cryodaq/core/zmq_bridge.py`. These must be placed in dedicated test files within the `tests/` directory.
- **HIGH**: Incorrect test grouping. `test_update_target_updates_runtime_p_target_immediately` tests `SafetyManager` functionality (e.g., `mgr.update_target()`), yet it is being appended to `zmq_bridge.py`. It should be placed in the appropriate `SafetyManager` test file (e.g., `tests/core/test_safety_manager.py`).
- **HIGH**: Missing imports/fixtures. `MagicMock`, `_mock_keithley`, and `_make_manager` are used in the test but are unlikely to be imported in the production `zmq_bridge.py` module. This will lead to `NameError`s if a test runner actually discovers and executes them.
