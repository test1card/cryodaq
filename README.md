...
(3158 тест-функций в 296 файлах).

Разработано для АКЦ ФИАН (проект Millimetron).

## Статус

- **Последний релиз:** v0.56.4 (2026-05-08)
- **Master:** `690e4ff`
- **Тесты:** 3158 тест-функций в 296 файлах
...
Полностью функциональны в v0.56.4:
...
Активные конфигурационные файлы на v0.56.4:
...
tests/           # 3158 тест-функций в 296 файлах
